...
public class InputStreamIoFile extends IoFile {
    ...
    public InputStreamIoFile(final URL url) throws IOException {
        this(url.openStream(), url.getPath());
    }

    public InputStreamIoFile(final InputStream stream) {
        this(stream, null);
    }

    public InputStreamIoFile(final InputStream stream, final String name) {
