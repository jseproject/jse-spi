...
public class ByteArrayReader {
    ...
    public ByteArrayReader(final IoFile io, int size) throws IOException {
    ...
    public void reset(final IoFile io, int size) throws IOException {
        index = 0;
        try {
    ...
    public String readString(int size, String encoding) {
        ...
        try {
            ...
            throw new APEException("Unsupported encoding", e);
        }
        index += size;
        return res;
    }
