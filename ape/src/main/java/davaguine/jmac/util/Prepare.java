...
public class Prepare {
    ...
    public void unprepare(int X, int Y, final WaveFormat waveFormat, final ByteArrayBuffer output, final Crc32 crc) {
    ...
    public void unprepareOld(int[] pInputX, int[] pInputY, int nBlocks, WaveFormat pWaveFormatEx, ByteArrayBuffer output, Crc32 crc, int nFileVersion) {
