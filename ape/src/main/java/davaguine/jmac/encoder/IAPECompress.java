...
import davaguine.jmac.util.ByteArrayBuffer;
...
public abstract class IAPECompress {
    ...
    public void StartEx(IoFile pioOutput, WaveFormat pwfeInput) throws IOException {
    ...
    public void StartEx(IoFile pioOutput, WaveFormat pwfeInput, int nMaxAudioBytes) throws IOException {
    ...
    public void StartEx(IoFile pioOutput, WaveFormat pwfeInput, int nMaxAudioBytes, int nCompressionLevel) throws IOException {
        StartEx(pioOutput, pwfeInput, nMaxAudioBytes, nCompressionLevel, null, CREATE_WAV_HEADER_ON_DECOMPRESSION);
    }

    public void StartEx(IoFile pioOutput, WaveFormat pwfeInput, int nMaxAudioBytes, int nCompressionLevel, byte[] pHeaderData) throws IOException {
        StartEx(pioOutput, pwfeInput, nMaxAudioBytes, nCompressionLevel, pHeaderData, CREATE_WAV_HEADER_ON_DECOMPRESSION);
    }

    public abstract void StartEx(IoFile pioOutput, WaveFormat pwfeInput, int nMaxAudioBytes, int nCompressionLevel, byte[] pHeaderData, int nHeaderBytes) throws IOException;
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
    // GetIdealFrameBytes(...) - returns the 'ideal' number of frame bytes
    // Naoko: add for debug
    //////////////////////////////////////////////////////////////////////////////////////////////
    public abstract int GetIdealFrameBytes();
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
    public abstract ByteArrayBuffer LockBuffer(IntegerPointer pBytesAvailable);
