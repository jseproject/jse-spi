...
public class WAVInputSource extends InputSource {
    ...
    public WAVInputSource(IoFile pIO, WaveFormat pwfeSource, IntegerPointer pTotalBlocks, IntegerPointer pHeaderBytes, IntegerPointer pTerminatingBytes) throws IOException {
    ...
    public WAVInputSource(String pSourceName, WaveFormat pwfeSource, IntegerPointer pTotalBlocks, IntegerPointer pHeaderBytes, IntegerPointer pTerminatingBytes) throws IOException {
        ...
        m_spIO = IoFile.createFile(pSourceName, "r");
        m_bOwnsInputIO = true;
    ...
    // get data
    public int GetData(ByteArrayBuffer pBuffer, int nBlocks) throws IOException {
        if (!m_bIsValid)
            throw new APEException("Undefined Error");
    ...
    private void AnalyzeSource() throws IOException {
        ...
        if (riffSignature != goalSignature)
            throw new APEException("Invalid Input File");
