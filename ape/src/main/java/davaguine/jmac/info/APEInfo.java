...
public class APEInfo {
    ...
    public APEInfo(java.io.File file, APETag pTag) throws IOException {
        this(new RandomAccessIoFile(file, "r"), pTag);
    }
    ...
    public APEInfo(InputStream pIO, APETag pTag) throws IOException {
        this(new InputStreamIoFile(pIO), pTag);
    }

    public APEInfo(IoFile pIO) throws IOException {
        this(pIO, null);
    }

    public APEInfo(IoFile pIO, APETag pTag) throws IOException {
        // open the file
        m_spIO = pIO;
    ...
    public IoFile getApeInfoIoSource() {
        return m_spIO;
    }
        ...
        if (m_APEFileInfo.nWAVTerminatingBytes > nMaxBytes)
            ...
            if (m_APEFileInfo.nWAVTerminatingBytes > 0) {
                ...
                try {
                    ...
                    throw new APEException("Can't Read WAV Terminating Bytes");
                }
