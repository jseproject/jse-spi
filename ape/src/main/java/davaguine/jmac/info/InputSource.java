...
public abstract class InputSource {
    ...
    public InputSource(IoFile pIO, WaveFormat pwfeSource, IntegerPointer pTotalBlocks, IntegerPointer pHeaderBytes, IntegerPointer pTerminatingBytes) throws IOException {
    }
    ...
    // get data
    public abstract int GetData(ByteArrayBuffer pBuffer, int nBlocks) throws IOException;
