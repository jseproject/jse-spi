...
public abstract class IAPEDecompress {
    ...
    public abstract IoFile getApeInfoIoSource();
    ...
    public static APEInfo CreateAPEInfo(IoFile in) throws IOException {
        // variables
    ...
    public static IAPEDecompress CreateIAPEDecompress(IoFile in) throws IOException {
        // variables
        APEInfo pAPEInfo = null;
        int nStartBlock = -1;
        int nFinishBlock = -1;
