...
public interface OggDecoderAspectReadCallbackProxy {
     ...
     */
	int ogg_read_callback(final StreamDecoder decoder, byte buffer[], int offset, int bytes/*, Object client_data*/) throws IOException;
}
