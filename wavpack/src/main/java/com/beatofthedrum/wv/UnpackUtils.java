...
class UnpackUtils
{
    ...
    static void decorr_stereo_pass(DecorrPass dpp, int [] buffer, long sample_count, int buf_idx)
    {
        int delta = dpp.delta;
    ...
    static void decorr_stereo_pass_cont(DecorrPass dpp, int [] buffer, long sample_count, int buf_idx)
    {
    ...
    static void decorr_mono_pass(DecorrPass dpp, int [] buffer, long sample_count, int buf_idx)
    {
