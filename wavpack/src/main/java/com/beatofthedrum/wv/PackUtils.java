                ...
                ((flags & (Defines.MONO_FLAG | Defines.FALSE_STEREO)) != 0))
        {
            for (bptr = buffer, i = 0; i < sample_count; ++i)
            {
                ...
                for (tcount = wps.num_terms; tcount > 0; tcount--)
                {
                    ...
                    wps.decorr_passes[dpp_idx].weight_A = update_weight((short) wps.decorr_passes[dpp_idx].weight_A,
                            (short) wps.decorr_passes[dpp_idx].delta, sam, code);
            ...
            for (bptr = buffer, i = 0; i < sample_count; ++i, byte_idx += 2)
            {
                ...
                for (tcount = wps.num_terms; tcount > 0; tcount--)
                {
                    if (wps.decorr_passes[dpp_idx].term > 0)
                    {
                        ...
                        wps.decorr_passes[dpp_idx].weight_A = update_weight((short) wps.decorr_passes[dpp_idx].weight_A,
                                (short) wps.decorr_passes[dpp_idx].delta, sam_A, left);
                        wps.decorr_passes[dpp_idx].weight_B = update_weight((short) wps.decorr_passes[dpp_idx].weight_B,
                                (short) wps.decorr_passes[dpp_idx].delta, sam_B, right);
                    }
                    else
                    {
                        ...
                        left -= apply_weight(wps.decorr_passes[dpp_idx].weight_A, sam_A);
                        right -= apply_weight(wps.decorr_passes[dpp_idx].weight_B, sam_B);
                        wps.decorr_passes[dpp_idx].weight_A = update_weight_clip((short) wps.decorr_passes[dpp_idx].weight_A,
                                (short) wps.decorr_passes[dpp_idx].delta, sam_A, left);
                        wps.decorr_passes[dpp_idx].weight_B = update_weight_clip((short) wps.decorr_passes[dpp_idx].weight_B,
                                (short) wps.decorr_passes[dpp_idx].delta, sam_B, right);
                    }
                ...
                ((flags & (Defines.MONO_FLAG | Defines.FALSE_STEREO)) != 0))
        {
            for (bptr = buffer, i = 0; i < sample_count; ++i)
            {
                ...
                while (dpp_idx >= 0)
                {
                    ...
                    {
                        wps.decorr_passes[dpp_idx].weight_A = update_weight((short) wps.decorr_passes[dpp_idx].weight_A,
                                (short) wps.decorr_passes[dpp_idx].delta,
