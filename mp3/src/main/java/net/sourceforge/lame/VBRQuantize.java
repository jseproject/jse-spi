...
*/
	...
	private static final class ALGO_s {
		...
		private LAME_InternalFlags gfc;
 ...
 ******************************************************************/
	...
	{
		final III_GrInfo cod_info = that.cod_info;
		final LAME_InternalFlags gfc = that.gfc;
	...
	******************************************************************/
	...
	private static int reduce_bit_usage(final LAME_InternalFlags gfc, final int gr, final int ch
/* #if 0
	...
	static final int VBR_encode_frame(final LAME_InternalFlags gfc, final float xr34orig[][][]/*[2][2][576]*/,
