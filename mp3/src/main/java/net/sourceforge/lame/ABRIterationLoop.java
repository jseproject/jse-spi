...
class ABRIterationLoop extends Quantize/* implements IterationLoop */{
	 ...
	 ********************************************************************/
	private static final long calc_target_bits(final InternalFlags gfc,
			final float pe[][]/*[2][2]*/,
	 ...
	 *
	 ********************************************************************/
	//private static final void ABR_iteration_loop(final InternalFlags gfc, final float pe[][]/*[2][2]*/,
