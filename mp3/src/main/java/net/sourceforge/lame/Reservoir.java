 ...
 */
	...
	static final long ResvFrameBegin(final LAME_InternalFlags gfc/*, final int[] mean_bits*/) {
 ...
 */
	...
	*/
	static final long ResvMaxBits(final LAME_InternalFlags gfc, final int mean_bits,/* final int[] targ_bits, final int[] extra_bits,*/ final boolean cbr) {
		final SessionConfig cfg = gfc.cfg;
		final EncStateVar esv = gfc.sv_enc;
	...
	*/
	static final void ResvAdjust(final LAME_InternalFlags gfc, final III_GrInfo gi) {
	...
	/**
	  ...
	  bits.
	*/
	static final void ResvFrameEnd(final LAME_InternalFlags gfc, final int mean_bits) {
		final SessionConfig cfg = gfc.cfg;
		final EncStateVar esv = gfc.sv_enc;
		final III_SideInfo l3_side = gfc.l3_side;
