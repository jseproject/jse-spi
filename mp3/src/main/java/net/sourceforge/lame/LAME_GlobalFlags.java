...
*
***********************************************************************/
public class LAME_GlobalFlags {// struct lame_global_struct
	//
	...
	/**************************************************************************/
	LAME_InternalFlags internal_flags;

	boolean is_lame_global_flags_valid() {
		/*if( gfp == null ) {
			return false;
		}*/
		return this.class_id == LAME_InternalFlags.LAME_ID;
	}
	/** number of samples
	...
	public final int lame_set_allow_diff_short(final boolean allow_diff_short) {
		if( is_lame_global_flags_valid() ) {
			this.short_blocks = allow_diff_short ? LAME_GlobalFlags.short_block_allowed : LAME_GlobalFlags.short_block_coupled;
			return 0;
		}
		return -1;
	}
	...
	public final int lame_get_allow_diff_short() {
		if( is_lame_global_flags_valid() ) {
			if( this.short_blocks == LAME_GlobalFlags.short_block_allowed ) {
	...
	public final int lame_set_no_short_blocks(final boolean no_short_blocks) {
		if( is_lame_global_flags_valid() ) {
			this.short_blocks = no_short_blocks ? LAME_GlobalFlags.short_block_dispensed : LAME_GlobalFlags.short_block_allowed;
			return 0;
		}
		return -1;
	}
	...
	public final int lame_get_no_short_blocks() {
		if( is_lame_global_flags_valid() ) {
			switch( this.short_blocks ) {
				default:
			case LAME_GlobalFlags.short_block_not_set:
				return -1;
			case LAME_GlobalFlags.short_block_dispensed:
				return 1;
			case LAME_GlobalFlags.short_block_allowed:
			case LAME_GlobalFlags.short_block_coupled:
			case LAME_GlobalFlags.short_block_forced:
				return 0;
			}
		}
		return -1;
	...
	public int lame_set_force_short_blocks(final boolean is_short_blocks)
	{
		if( is_lame_global_flags_valid() ) {
			...
			if( is_short_blocks ) {
				this.short_blocks = LAME_GlobalFlags.short_block_forced;
			} else if( this.short_blocks == LAME_GlobalFlags.short_block_forced ) {
				this.short_blocks = LAME_GlobalFlags.short_block_allowed;
			}
	...
	public final int lame_get_version() {
		if( is_lame_global_flags_valid() ) {
			final LAME_InternalFlags gfc = this.internal_flags;
