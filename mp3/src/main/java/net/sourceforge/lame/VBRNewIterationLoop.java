...
class VBRNewIterationLoop extends Quantize/* implements IterationLoop */{
	 ...
	 */
	private static final int VBR_new_prepare(final InternalFlags gfc,
	...
	// @Override
	static final void iteration(final InternalFlags gfc, final float pe[][], final float ms_ratio[], final III_PsyRatio ratio[][] ) {
		final SessionConfig cfg = gfc.cfg;
		final EncResult eov = gfc.ov_enc;
